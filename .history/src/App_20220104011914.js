...
import UserDashboardSummary from './Dashboard/UserDashboard/UserDashboardSummary';
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="/dashboard/userDashBoardSummary" element={<PrivateRoute><UserDashboardSummary/> </PrivateRoute>}></Route>
            </Route>
          </Routes>
        </BrowserRouter>
      </AuthProvider>
