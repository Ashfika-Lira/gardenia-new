...
import AddProducts from './Dashboard/AddProdects';
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="/dashboard/updateProducts" element={<PrivateRoute><AllProducts/> </PrivateRoute>}></Route>
              <Route path="/dashboard/updateProducts" element={<PrivateRoute><UpdatPro/> </PrivateRoute>}></Route>
            </Route>
          </Routes>
        </BrowserRouter>
      </AuthProvider>
