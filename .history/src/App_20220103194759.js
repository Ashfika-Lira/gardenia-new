        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="/dashboard/adminDashboard" element={<PrivateRoute>  </PrivateRoute>}></Route>
              <Route path="/dashboard/adminDashboard" element={<AdminRoute> <AdminDashboard/></AdminDashboard></AdminRoute>}></Route>
              <Route path={""} element={<AdminRoute></AdminRoute>}></Route>
              <Route path={""} element={<AdminRoute></AdminRoute>}></Route>
